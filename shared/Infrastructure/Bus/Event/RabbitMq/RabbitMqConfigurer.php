...
use Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqExchangeNameFormatter;
...
final class RabbitMqConfigurer
{
    ...
    public function __construct(\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqConnection $connection)
    {
    ...
    public function configure(string $exchangeName, DomainEventSubscriber ...$subscribers): void
    {
        ...
        $deadLetterExchangeName = \Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqExchangeNameFormatter::deadLetter($exchangeName);
    ...
    private function queueDeclarator(
        ...
        return function (DomainEventSubscriber $subscriber) use (
            ...
            $queueName           = \Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqQueueNameFormatter::format($subscriber);
