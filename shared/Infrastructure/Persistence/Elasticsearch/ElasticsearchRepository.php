...
use Shared\Infrastructure\Elasticsearch\ElasticsearchClient;
...
{
    public function __construct(private \Shared\Infrastructure\Elasticsearch\ElasticsearchClient $client)
    {
    }
